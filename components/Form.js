...
const Form = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            message: Yup.string()
                .required('Por favor llene este campo con una explicación detallada de lo que desea')
        ...
        <Box className={styles.form}>
            ...
            >
                <Grid container spacing={2}>
                    ...
                    <Container>
                        <Grid className={styles.nombre} container spacing={-1} columnSpacing={1}>
                ...
                <Box className={styles.center}>
                    <Button className={styles.button} type="submit" variant="outlined" color='inherit'>Enviar</Button>
                </Box>
            </form>
        </Box>
    )
